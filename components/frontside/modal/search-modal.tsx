    ...
    <div className="flex flex-1">
      ...
      <CommandDialog open={open} onOpenChange={setOpen}>
        <Command className="rounded-lg border shadow-md">
          <CommandInput placeholder="Search Product..." value={searchTerm} onValueChange={setSearchTerm} className="h-12 text-lg"/>
          <CommandList className="max-h-[70vh] overflow-y-auto p-4">
            ...
            <CommandGroup>
              {filteredProducts.map((product) => (
                ...
                >
                  <Image src={product.images[0].url} alt={product.name} width={48} height={48} className="rounded-md object-cover"/>
